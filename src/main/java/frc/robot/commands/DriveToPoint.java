...
public class DriveToPoint extends Command {
  ...
  private static final double kXMaxSpeed = 0.5;     // Maximum X velocity (0-1 normalized)
  ...
  private static final double kYMaxSpeed = 0.5;     // Maximum Y velocity (0-1 normalized)
  ...
  private static final double kMaxRotationSpeed = 0.75;   // Maximum rotation speed (0-1 normalized)
